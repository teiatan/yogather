...
import { AccentText, HeroContainerUi, ImageUI, ImagesBlockUI, LeftPartContainerUI, MainHeading, SmallImagesBlockUI } from "./Hero.styled";
...
export const Hero = () => {
    return(<SectionContainer>
        <HeroContainerUi>
            <LeftPartContainerUI>
                <MainHeading>
                    Personalized <AccentText>yoga</AccentText> training and supportive community <AccentText>in phone</AccentText>
                </MainHeading> 
